...
android {
    namespace = "com.example.ano"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.ano"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    // Configuration spécifique à Firebase App Distribution
    firebaseAppDistribution {
        appId = "diko-652b0" // Remplacez par votre ID d'application Firebase
